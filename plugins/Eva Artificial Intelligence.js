...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Ajuser voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel rocky özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = ' yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'apay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = ' Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional rocky features. Turn your account into a ai chatbot!'
...
if (conf.LANG == 'ML') {
    fulleva_dsc = 'Ajuser പൂർണ്ണമായും പ്രവർത്തനക്ഷമമായ സവിശേഷതകൾ സജീവമാക്കുന്നു. നിങ്ങളുടെ അക്കൗണ്ട് ഒരു ചാറ്റ്ബോട്ടാക്കി മാറ്റുക!'
    already_on = 'Ajuserകൃത്രിമബുദ്ധി ഇതിനകം പൂർണ്ണമായി പ്രവർത്തിക്കുന്നു.'
